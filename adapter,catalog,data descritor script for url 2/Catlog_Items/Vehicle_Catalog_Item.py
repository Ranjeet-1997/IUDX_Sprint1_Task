...
for i in range(l):
    ...
    item["tags"] = ["vehicleNo","speed","longitude","latitude", "dateTime","VehicleStatus","altitude", "angle", "batteryStatus", "ignition","location", "simNo"]
    ...
    a.append(item)
with open("/home/admin1/PycharmProjects/VaranasiVechileCatalogItem/varanasi_TransitManagement/Catlog_Items/Vehicle_Catalog_Item.jsonld", "w+") as outs:
